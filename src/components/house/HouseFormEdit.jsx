...
import { useGetHouseByIdQuery, useUpdateHouseMutation, useUploadImageMutation} from "../../features/api/apiHousesSlice";
...
export default function UserFormEdit(){
    ...
    const [updateHouse] = useUpdateHouseMutation() //TODO: replace to Update
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await updateHouse(newHouse)
    ...
    return (
        <HouseForm props={{handleSubmit:handleSubmit, handleChangeImage: handleChangeImage, house:house}} />
    );
}