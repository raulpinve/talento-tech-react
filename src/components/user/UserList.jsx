                ...
                <table className="table-auto w-full">
                    <thead>
                        <tr className="font-semibold text-sm rounded">
                            ...
                            <th className="px-4 py-2">Idetificación</th>
                    ...
                    <tbody className='text-sm text-center'>
                        {users.map(user => (
                            <tr key={user._id}>
                                <td className="border-y px-4 py-2 border-slate-200">{user.name}</td>
                                <td className="border-y px-4 py-2 border-slate-200">{user.lastname}</td>
                                <td className="border-y px-4 py-2 border-slate-200">{user.email}</td>
                                <td className="border-y px-4 py-2 border-slate-200">{user.id}</td>
